...
import KanbanBoard from "@/components/kanbanBoardNew/KanbanBoard";
import { Skeleton } from "@/components/ui/skeleton";
import { H4 } from "@/components/ui/typography";
import { trpc } from "@/lib/trpc";
import { createFileRoute } from "@tanstack/react-router";

export const Route = createFileRoute("/dashboard/boards/$boardId")({
...
function MainContent() {
  ...
  return (
    <div className="w-full bg-background grid grid-rows-[auto_1fr] h-[100vh]">
