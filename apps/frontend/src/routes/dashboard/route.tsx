...
export function Dashboard() {
	...
	return (
		<div className="flex min-h-screen max-w-screen w-full bg-muted/40">
			<div className="bg-background border-r z-50 gap-2  flex flex-col h-full fixed w-[60px] hover:w-[256px] group transition-all duration-200 ease-in-out overflow-hidden px-3">
				...
				<Collapsible open>
					...
					<CollapsibleContent>
						<div className="opacity-0 ml-4 mt-2 flex flex-col gap-2 group-hover:opacity-100 transition-all duration-200 ease-in-out">
			...
			<div className="ml-[60px] w-full  min-h-screen bg-background">
				<Outlet />
			</div>
		</div>
	);
