...
export interface MinimalTiptapProps
  ...
  maxHeight?: string; // Added this line
}
  ...
  (
    {
      ...
      onValueChange,
      className,
      maxHeight = "400px", // Added this line with a default value
      ...props
    },
    ref,
  ) => {
    ...
    return (
      <div
        className={cn(
          "flex w-full flex-col rounded-md border border-input shadow-sm focus-within:border-primary",
          className,
        )}
        style={{ maxHeight }} // Added this line
        {...props}
        ref={ref}
      >
        {editor && (
        ...
        <div
          className="h-full grow overflow-y-auto" // Added overflow-y-auto here
